...
<div class="row form-group{{ $errors->has('author_id') ? ' has-error' : '' }}">
    {!! Form::label('author_id', 'Penulis', ['class'=>'col-md-2 control-label']) !!}
    <div class="col-md-4">
        {!! Form::select('author_id', [''=>'']+App\Author::pluck('name','id')->all(), null, array('id' => 'select-beast', 'placeholder' => 'Pilih Penulis...')) !!}
...
<div class="row form-group{{ $errors->has('cover') ? ' has-error' : '' }}">
